...
import "../../css/page/artistprofile.css";

import IconEdit from "../../asset/icon/edit.svg";
import IconPlays from "../../asset/icon/play.svg";
...
import { baseFetch, formatToK, onSkip } from "../../main";
          ...
          <div className="wrap-info-stats">
            <div className="info">
              <div className="wrap-name-varified">
                ...
                {isLoggedIn && <IconEdit className="icon" onClick={() => { navigate('updateprofileinfo') }} />}
              </div>
